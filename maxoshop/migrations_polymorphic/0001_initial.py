    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(related_name='+', default=None, to='maxoshop.Address', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ...
                ('cart', models.ForeignKey(related_name='items', to='maxoshop.Cart')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(related_name='orders', verbose_name='Customer', to='maxoshop.Customer')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(related_name='items', verbose_name='Order', to='maxoshop.Order')),
            ],
        ),
        migrations.CreateModel(
            name='OrderPayment',
            fields=[
                ...
                ('order', models.ForeignKey(verbose_name='Order', to='maxoshop.Order')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SmartCard',
            fields=[
                ('product_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='maxoshop.Product')),
                ('unit_price', models.DecimalField(default='0', help_text='Net price for this product', max_digits=30, decimal_places=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_system', models.ForeignKey(verbose_name='Operating System', to='maxoshop.OperatingSystem')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='master',
            field=models.ForeignKey(related_name='translations', to='maxoshop.Product', null=True),
        ),
        migrations.AddField(
            model_name='productpage',
            name='product',
            field=models.ForeignKey(to='maxoshop.Product'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='product',
            name='cms_pages',
            field=models.ManyToManyField(help_text='Choose list view this product shall appear on.', to='cms.Page', through='maxoshop.ProductPage'),
        ),
        migrations.AddField(
            model_name='product',
            name='images',
            field=models.ManyToManyField(to='filer.Image', through='maxoshop.ProductImage'),
        ),
        migrations.AddField(
            model_name='product',
            name='manufacturer',
            field=models.ForeignKey(verbose_name='Manufacturer', to='maxoshop.Manufacturer'),
        ),
        migrations.AddField(
            model_name='product',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_maxoshop.product_set+', editable=False, to='contenttypes.ContentType', null=True),
        ),
        migrations.AddField(
            model_name='orderitem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='Product', blank=True, to='maxoshop.Product', null=True),
        ),
        migrations.AddField(
            model_name='cartitem',
            name='product',
        ...
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.OneToOneField(related_name='cart', verbose_name='Customer', to='maxoshop.Customer'),
        ),
        migrations.AddField(
            model_name='cart',
            name='shipping_address',
            field=models.ForeignKey(related_name='+', default=None, to='maxoshop.Address', null=True),
        ),
        migrations.AddField(
            model_name='address',
            name='customer',
            field=models.ForeignKey(to='maxoshop.Customer'),
        ),
        migrations.AddField(
            model_name='smartphone',
            name='product',
            field=models.ForeignKey(verbose_name='Smart-Phone Model', to='maxoshop.SmartPhoneModel'),
        ),
